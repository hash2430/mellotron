...
audio_paths = 'data/examples_fv01.txt'
...
for i, batch in enumerate(dataloader):
    ...
    for k in range(7,8):
        with torch.no_grad():
            ...
            inputs = text_encoded, k, speaker_id, pitch_contour
            mel_outputs, mel_outputs_postnet, gate_outputs, rhythm = mellotron.inference(inputs)
        ...
        with torch.no_grad():
            ...
            for j in range(len(audio)):
                ...
                write("gen/refer_pitch/{}/target-{}_refer-{}_topdb-{}_{}_token-{}_original_text.wav".format(reference_speaker, speaker, reference_speaker, top_db, i*hparams.batch_size+j, k), hparams.sampling_rate, wav)
