...
stft = TacotronSTFT(hparams.filter_length, hparams.hop_length, hparams.win_length,
                    ...
                    hparams.mel_fmax)
speaker = "Main"
checkpoint_path ='/mnt/sdc1/mellotron/grl_200224/checkpoint_209500'
...
# TODO: Visualize reference speaker and target speaker prediction 'speaker_predicted' and 'speaker_inferenced' to see how terrible they are.

    with torch.no_grad():
        # get rhythm (alignment map) using tacotron 2
        mel_outputs, mel_outputs_postnet, gate_outputs, rhythm, speaker_predicted = mellotron.forward(x)
        rhythm = rhythm.permute(1, 0, 2)

        # Using mel as input is not generalizable. I hope there is generalizable inference method as well.
        mel_outputs, mel_outputs_postnet, gate_outputs, _, speaker_inferenced = mellotron.inference_noattention(
    ...
    with torch.no_grad():
        ...
        for j in range(len(audio)):
            ...
            write("gen/refer_pitch_rythm_mel/{}/target-{}_refer-{}_topdb-{}_{}_rel_f0_scale_min_and_max_rescale_grl_02.wav".format(reference_speaker, speaker, reference_speaker, top_db, i * hparams.batch_size + j), hparams.sampling_rate, wav)
