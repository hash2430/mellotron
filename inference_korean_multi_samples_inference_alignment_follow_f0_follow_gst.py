...
for i, batch in enumerate(dataloader):
    ...
    with torch.no_grad():
        ...
        inputs = text_encoded, mel, speaker_id, pitch_contour
    ...
    with torch.no_grad():
        ...
        for j in range(len(audio)):
            ...
            write("gen/refer_pitch/{}/target-{}_refer-{}_topdb-{}_{}_original_text.wav".format(reference_speaker, speaker, reference_speaker, top_db, i*hparams.batch_size+j), hparams.sampling_rate, wav)
